...
<form action="SoftWarewrite" method="post" id="input">
<tr>
<td> 이름 </td>
<td> <input type="text" name="s_name" size = "60"> </td>
</tr>
<tr>
<td> 제목 </td>
<td> <input type="text" name="s_subject" size = "60"> </td>
</tr>
<tr>
<td> 카테고리 </td>
...
<tr>
<td> 가격 </td>
<td> <input type="text" name="s_price" size = "60"> </td>
</tr>
<tr>
<td> 내용 </td>
<td> <textarea name="s_content" rows="10" ></textarea> </td>
</tr>
<tr>
<td> 별점 </td>
<td> <input type="text" name="s_score" size = "60"> </td>
</tr>
<tr >
<td colspan="2"> 
<a href="#" onclick="document.getElementById('input').submit();"><img src="resources/regist_b.gif"/></a> &nbsp;&nbsp; 
<a href="SoftWarelist.do"><img src="resources/list_b.gif"></a></td>
