...
<tr>
<td> 이름 </td>
<td>${content_view.b_name}</td>
</tr>
<tr>
<td> 제목 </td>
<td>${content_view.b_subject}</td>
</tr>
<tr>
<td> 내용 </td>
<td>${content_view.b_content}</td>
</tr>
<tr >
<td colspan="2"> 
<a href="content_modify?b_no=${content_view.b_no}"><img src="resources/mod_b.gif"/></a> &nbsp;&nbsp; 
<a href="list"><img src="resources/list_b.gif"></a> &nbsp;&nbsp; 
<a href="delete?b_no=${content_view.b_no}"><img src="resources/del_b.gif"></a> &nbsp;&nbsp; 
