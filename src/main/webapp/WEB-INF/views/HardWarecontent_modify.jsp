...
<form action="HardWaremodify" method="post" id="frm">
<input type="hidden" name="h_no" value="${HardWarecontent_view.h_no}">
<tr>
<td> 번호 </td>
<td> ${HardWarecontent_view.h_no} </td>
</tr>
<tr>
<td> 제목 </td>
<td> <input type="text" name="h_subject" value="${HardWarecontent_view.h_subject}"></td>
</tr>
<tr>
<td> 이름 </td>
<td> <input type="text" name="h_name" value="${HardWarecontent_view.h_name}"></td>
</tr>
<tr>
<td> 카테고리 </td>
...
<tr>
<td> 가격 </td>
<td> <input type="text" name="h_price" value="${HardWarecontent_view.h_price}"></td>
</tr>
<tr>
<td> 내용 </td>
<td> <textarea rows="10" name="h_content" >${HardWarecontent_view.h_content}</textarea></td>
</tr>
<tr>
<td> 별점 </td>
<td> <input type="text" name="h_score" value="${HardWarecontent_view.h_score}"></td>
</tr>
<tr >
<td colspan="2"> 
<a href="#" onclick="document.getElementById('frm').submit();"><img src="resources/mod_b.gif"/></a> &nbsp;&nbsp; 
<a href="HardWarelist"><img src="resources/list_b.gif"></a> &nbsp;&nbsp; 
<a href="HardWaredelete?h_no=${HardWarecontent_view.h_no}"><img src="resources/del_b.gif"></a> &nbsp;&nbsp; 
<a href="reply_view?h_no=${HardWarecontent_view.h_no}"></a></td>
