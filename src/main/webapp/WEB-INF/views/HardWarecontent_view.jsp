...
<tr>
<td> 제목 </td>
<td>${HardWarecontent_view.h_subject}</td>
</tr>
<tr>
<td> 조회수 </td>
<td> ${HardWarecontent_view.h_count}</td>
</tr>
<tr>
<td> 이름 </td>
<td>${HardWarecontent_view.h_name}</td>
</tr>
<tr>
<td> 카테고리 </td>
<td>${HardWarecontent_view.h_code}</td>
</tr>
<tr>
<td> 가격 </td>
<td>${HardWarecontent_view.h_price}</td>
</tr>
<tr>
<td> 내용 </td>
<td><textarea rows="10" name="h_content" readonly>${HardWarecontent_view.h_content}</textarea></td>
</tr>
<tr>
<td> 별점 </td>
<td> ${HardWarecontent_view.h_score}</td>
</tr>
<tr>
<td> 추천수 </td>
<td> ${HardWarecontent_view.h_suggest}</td>
</tr>
<tr>
<td colspan="2"> 

<a href="HardWarecontent_modify?h_no=${HardWarecontent_view.h_no}"><img src="resources/mod_b.gif"/></a> &nbsp;&nbsp; 
