...
<input type="hidden" name="s_no" value="${SoftWarecontent_view.s_no}">
<tr>
<td> 번호 </td>
...
<tr>
<td> 제목 </td>
<td> <input type="text" name="s_subject" value="${SoftWarecontent_view.s_subject}"></td>
</tr>
<tr>
<td> 이름 </td>
<td> <input type="text" name="s_name" value="${SoftWarecontent_view.s_name}"></td>
</tr>
<tr>
<td> 카테고리 </td>
<td> <select name="s_code" id="sel_box">
...
<tr>
<td> 가격 </td>
<td> <input type="text" name="s_price" value="${SoftWarecontent_view.s_price}"></td>
</tr>
<tr>
<td> 내용 </td>
<td> <textarea rows="10" name="s_content" >${SoftWarecontent_view.s_content}</textarea></td>
</tr>
<tr>
<td> 별점 </td>
<td> <input type="text" name="s_score" value="${SoftWarecontent_view.s_score}"></td>
</tr>
<tr>
<td colspan="2"> 
