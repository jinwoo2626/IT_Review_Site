...
<title></title>
        <link rel="icon" href="corona19.png">
    ...
    <!--메뉴-->
        ...
        <center>
        <div class="menu">
<a href="HardWarelist?category=CPU">CPU</a> 
<a href="HardWarelist?category=MAINBOARD">MAINBOARD</a> 
<a href="HardWarelist?category=GRAPHICCARD">GRAPHICCARD</a> 
<a href="HardWarelist?category=RAM">RAM</a> 
<a href="HardWarelist?category=POWER">POWER</a> 
<a href="HardWarelist?category=SSD">SSD</a> 
<a href="HardWarelist?category=HDD">HDD</a> 
</div>
<br><br><br>
...
<c:forEach items="${HardWarelist}" var="dto">
<tr>
<td>${dto.h_no}</td>
<td>${dto.h_name}</td>
<td>
<!--<c:forEach begin="1" end="${dto.h_no}">-</c:forEach>-->
<a href="HardWarecontent_view?h_no=${dto.h_no}">${dto.h_subject}</a></td>
<td>${dto.h_code}</td><td>${dto.h_time}</td><td>${dto.h_suggest}</td><td>${dto.h_count}</td>
</tr>
</c:forEach>
<tr>  
<td colspan="7"> <a href="HardWarewrite_view"><img src="resources/write_b.gif"></a></td>
