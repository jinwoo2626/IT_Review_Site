...
<link rel="stylesheet" href="https://stackpath.bootstrapcdn.com/bootstrap/4.5.0/css/bootstrap.min.css" integrity="sha384-9aIt2nRpC12Uk9gS9baDl411NQApFmC26EwAOH8WgZl5MYYxFfc+NcPb1dKGj7Sk" crossorigin="anonymous">
    ...
    <!--메뉴-->
        ...
        .
<form action="loginlater" method="post" name=login>
<fieldset>
<center><p id="a2">로그인</p></center>
<center>
<table>
<tr>
<td>
<input type="text" class="form-control" name="user_id" maxlength="20" placeholder="아이디"></td>
</tr>
<tr>
<td><input type="password" class="form-control" name="user_pwd" maxlength="20" placeholder="비밀번호"></td>
</tr>
<tr>
<td>
<center>
<input type=button value="로그인" class="btn btn-primary" style="background-color:#0080FF;width:138px;" OnClick="javascript:writeCheck();">
<input type=button value="취소" class="btn btn-secondary" style="float: right;width:90px;" OnClick="javascript:history.back(-1)">
</center>
 </td>
 </tr>
 </table>
